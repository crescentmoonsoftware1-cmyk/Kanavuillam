            ...
            child: Row(
              ...
              children: [
                const Icon(Icons.location_city,
                        size: 150, color: Color(0xFFEDF2F7))
                ...
                const Icon(Icons.location_city,
                        size: 200, color: Color(0xFFF1F5F9))
                    .animate(onPlay: (c) => c.repeat(reverse: true))
                    .slideY(
                        begin: -0.02,
                        end: 0.05,
                        ...
                        curve: Curves.easeInOutSine),
                const Icon(Icons.location_city,
                        size: 120, color: Color(0xFFEDF2F7))
                    .animate(onPlay: (c) => c.repeat(reverse: true))
                    .slideY(
                        begin: 0,
                        end: -0.08,
            ...
            child: Opacity(
              ...
              child: CustomPaint(
                ...
                painter: _BlueprintPainter(),
                  ...
                  .animate()
                  .fadeIn(delay: 500.ms, duration: 1.5.seconds)
                  .slideY(begin: 0.2),
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Container(
                        width: 20, height: 1, color: const Color(0xFF2979FF)),
